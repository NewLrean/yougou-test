 ...
 */
function login() {
    return location.href = "http://localhost:9008/page/login";
}
function regist() {
    return location.href = "http://localhost:9008/page/register";
}
...
function search(a) {
    var b = "http://localhost:9002/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
